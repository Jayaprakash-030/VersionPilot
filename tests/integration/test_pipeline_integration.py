...
class TestPipelineIntegration(unittest.TestCase):
    ...
    def test_run_pipeline_with_mocked_sources(self, mock_repo, mock_deps, mock_sec) -> None:
        ...
        # dependency score = 100 (outdated still placeholder = 0)
        self.assertEqual(report.breakdown.dependency_score, 100.0)
        # security penalty = 20 + 8 = 28 => 72
        self.assertEqual(report.breakdown.security_score, 72.0)

        # weighted: 86*0.3 + 100*0.4 + 72*0.3 = 87.4
        self.assertEqual(report.health_score, 87.4)
